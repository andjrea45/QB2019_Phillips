...
```{r}
getwd()
setwd("~/Github2/QB2019_Phillips/2.Worksheets/6.DiversitySampling")
#jellybeanAB <- read.table("~/Github2/QB2019_Phillips/2.Worksheets/6.DiversitySampling/JellyBeans.txt", sep = "\t", row.names = 1, header = TRUE)
#jellybeansource <- read.table("~/Github2/QB2019_Phillips/2.Worksheets/6.DiversitySampling/JellyBeans.Source.txt", sep = "\t", row.names = 1, header = TRUE)
```
